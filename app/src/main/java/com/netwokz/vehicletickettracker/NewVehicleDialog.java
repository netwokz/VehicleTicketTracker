...
public class NewVehicleDialog extends DialogFragment implements View.OnClickListener {
    ...
    public static NewVehicleDialog newInstance() {
        NewVehicleDialog mFragment = new NewVehicleDialog();
        return mFragment;
    }
